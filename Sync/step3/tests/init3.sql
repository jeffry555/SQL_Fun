...
INSERT INTO alarm_def ( alarm_id, name, mib_val, operator, threshold, description, severity, disabled )
    VALUES
    ( 1, 'Total CPU High', 'cpu_percent', '>=', 0.87, 'Total CPU higher than normal', 1, false ),
    ( 2, 'Total CPU Low', 'cpu_percent', '<', 0.025, 'Total CPU higher than normal', 4, false ),
    ( 3, 'IO High', 'disk_io', '>=', 0.70, 'Disk IO higher than normal', 2, false ),
    ( 4, 'Free Mem Low', 'mem_free', '<', 256, 'free memory lower than normal', 2, false ),
